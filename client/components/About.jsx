        ...
        <div className="flex flex-col xl:flex-row">
          ...
          <div className="flex-1 flex justify-center items-center">
            <Tabs defaultValue="personal">
              <TabsList className="w-full grid xl:grid-cols-3 xl:max-w-[520px] xl:border dark:border-none lg:items-center lg:grid-cols-3 lg:justify-center">
              ...
              <div className="text-lg mt-12 xl:mt-8">
                ...
                <TabsContent value="personal">
                  <div className="text-center xl:text-left">
                    <h3 className="h3 mb-4">Passionate Full Stack:</h3>
                    <p className="subtitle max-w-xl mx-auto xl:mx-0">
                      My name is ILYASS NASRALLAH, I'm 23 years old. I am a
                      passionate Full Stack JavaScript developer. I have strong
                      communication and adaptability skills, and I am highly
                    ...
                    {/* <div className="flex-1 lg:flex xl:flex xl:flex-col"> */}
                      ...
                      {/* <div className="flex flex-col gap-y-2">
                        ...
                        <div>
                          <span className="font-bold text-2xl">. </span>Mother
                          Tongue is <span className="font-bold">Arabic</span>
                        </div>
                        <div>
                          <span className="font-bold text-2xl">. </span>Fluent
                          in <span className="font-bold">ENGLISH</span>
                        </div>
                        <div>
                          <span className="font-bold text-2xl">. </span>
                          Proficient in{" "}
                          <span className="font-bold">Deutsch and Spanish</span>
                        </div>
                        <div>
                          <span className="font-bold text-2xl">. </span>
                          Conversant in{" "}
                ...
                <TabsContent value="skills">
                  <div className="text-center xl:text-left">
                    <h3 className="h3 mb-8">
                      What I Use Everyday As A Developer?
                    </h3>
                    {/* skills */}
                    <div className="mb-12">
